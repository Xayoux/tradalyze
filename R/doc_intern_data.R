...
#' Classification géographique utilisée par la base CHELEM au niveau de grandes régions
#'
#' @format ## `classification_chelem`
#' Un dataframe avec 196 lignes et 3 colonnes :
#' \describe{
#'   \item{iso_region}{Code iso3 utilisé pour définir les régions géographiques.}
